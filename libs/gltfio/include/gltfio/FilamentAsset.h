...
public:
    ...
    */
    ...
    /**
     * Lazily creates a single LINES entity that draws the transformed bounding-box hierarchy for
     * diagnostic purposes. The wireframe is owned by the asset and should not be deleted.
    */
